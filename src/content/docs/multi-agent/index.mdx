...
As systems grow complex, single agents give way to multi-agent patterns where specialists collaborate. The core patterns are sequential workflows, concurrent fan-out, handoffs, supervisor delegation, councils, group chat refinement, and dynamic orchestration. Most production systems combine patterns with a deterministic backbone and AI at decision points.
...
- Supervisor: one lead agent delegates while retaining control
- Council: multiple agents independently answer the same problem, then a synthesis step decides
...
- **Council and review patterns** — independent specialist answers with a final synthesis or approval step
